set moduleName flash_attention_hls_Pipeline_FIND_MAX
set isTopModule 0
...
set C_modelName {flash_attention_hls_Pipeline_FIND_MAX}
set C_modelType { void 0 }
set C_modelArgList {
	{ k_lim int 32 regular  }
	{ zext_ln138 int 6 regular  }
	{ scores float 32 regular {array 64 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ zext_ln138 sc_in sc_lv 6 signal 1 } 
	{ scores_address0 sc_out sc_lv 6 signal 2 } 
	{ scores_ce0 sc_out sc_logic 1 signal 2 } 
	{ scores_q0 sc_in sc_lv 32 signal 2 } 
	{ tile_max_out sc_out sc_lv 32 signal 3 } 
	{ tile_max_out_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ grp_fu_948_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_948_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_948_p_opcode sc_out sc_lv 5 signal -1 } 
	{ grp_fu_948_p_dout0 sc_in sc_lv 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_948_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "grp_fu_948_p_opcode", "role": "default" }} , 
 	{ "name": "grp_fu_948_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_948_p_dout0", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	scores { ap_memory {  { scores_address0 mem_address 1 6 }  { scores_ce0 mem_ce 1 1 }  { scores_q0 in_data 0 32 } } }
