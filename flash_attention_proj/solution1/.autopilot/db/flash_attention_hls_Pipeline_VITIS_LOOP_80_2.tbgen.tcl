set moduleName flash_attention_hls_Pipeline_VITIS_LOOP_80_2
set isTopModule 0
...
set C_modelName {flash_attention_hls_Pipeline_VITIS_LOOP_80_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ d int 32 regular  }
	{ zext_ln82 int 6 regular  }
	{ acc float 32 regular {array 64 { 0 3 } 0 1 }  }
	{ acc_1 float 32 regular {array 64 { 0 3 } 0 1 }  }
	{ acc_2 float 32 regular {array 64 { 0 3 } 0 1 }  }
	{ acc_3 float 32 regular {array 64 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "d", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln82", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln82 sc_in sc_lv 6 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln82", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln82", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln82 { ap_none {  { zext_ln82 in_data 0 6 } } }
	acc { ap_memory {  { acc_address0 mem_address 1 6 }  { acc_ce0 mem_ce 1 1 }  { acc_we0 mem_we 1 1 }  { acc_d0 mem_din 1 32 } } }
	acc_1 { ap_memory {  { acc_1_address0 mem_address 1 6 }  { acc_1_ce0 mem_ce 1 1 }  { acc_1_we0 mem_we 1 1 }  { acc_1_d0 mem_din 1 32 } } }
	acc_2 { ap_memory {  { acc_2_address0 mem_address 1 6 }  { acc_2_ce0 mem_ce 1 1 }  { acc_2_we0 mem_we 1 1 }  { acc_2_d0 mem_din 1 32 } } }
	acc_3 { ap_memory {  { acc_3_address0 mem_address 1 6 }  { acc_3_ce0 mem_ce 1 1 }  { acc_3_we0 mem_we 1 1 }  { acc_3_d0 mem_din 1 32 } } }
}
