...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.flash_attention_hls.autotvin_gmem0.dat"
         "c.flash_attention_hls.autotvin_gmem1.dat"
         "c.flash_attention_hls.autotvin_gmem2.dat"
         "c.flash_attention_hls.autotvin_Q.dat"
         "c.flash_attention_hls.autotvin_K.dat"
         "c.flash_attention_hls.autotvin_V.dat"
         "c.flash_attention_hls.autotvin_O.dat"
         "c.flash_attention_hls.autotvin_N.dat"
         "c.flash_attention_hls.autotvin_d.dat"
         "c.flash_attention_hls.autotvin_causal.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.flash_attention_hls.autotvout_gmem3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
