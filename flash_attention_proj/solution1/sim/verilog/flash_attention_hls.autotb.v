...
`define AUTOTB_DUT      flash_attention_hls
`define AUTOTB_DUT_INST AESL_inst_flash_attention_hls
`define AUTOTB_TOP      apatb_flash_attention_hls_top
`define AUTOTB_LAT_RESULT_FILE "flash_attention_hls.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "flash_attention_hls.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_flash_attention_hls_top
...
`define AESL_DEPTH_O 1
`define AESL_DEPTH_N 1
`define AESL_DEPTH_d 1
`define AESL_DEPTH_causal 1
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvin_gmem2.dat"
`define AUTOTB_TVIN_Q_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvin_Q.dat"
`define AUTOTB_TVIN_K_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvin_K.dat"
`define AUTOTB_TVIN_V_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvin_V.dat"
`define AUTOTB_TVIN_O_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvin_O.dat"
`define AUTOTB_TVIN_N_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvin_N.dat"
`define AUTOTB_TVIN_d_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvin_d.dat"
`define AUTOTB_TVIN_causal_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvin_causal.dat"
`define AUTOTB_TVOUT_gmem3  "../tv/cdatafile/c.flash_attention_hls.autotvout_gmem3.dat"
`define AUTOTB_TVOUT_gmem3_out_wrapc  "../tv/rtldatafile/rtl.flash_attention_hls.autotvout_gmem3.dat"
module `AUTOTB_TOP;
...
reg end_causal;
reg [31:0] size_causal;
reg [31:0] size_causal_backup;
reg end_gmem3;
reg [31:0] size_gmem3;
