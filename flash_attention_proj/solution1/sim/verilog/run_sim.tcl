...
set ret [catch {eval exec ./cosim.tv.exe rtl | tee temp0.log >&@ stdout} err]
...
if {[file isfile flash_attention_hls.autotvin.dat]} {
	file delete -force flash_attention_hls.autotvin.dat
}

if {[file isfile flash_attention_hls.autotvout.dat]} {
	file delete -force flash_attention_hls.autotvout.dat
}
...
set ret [catch {eval exec ./cosim.pc.exe rtl | tee temp0.log >&@ stdout} err]
