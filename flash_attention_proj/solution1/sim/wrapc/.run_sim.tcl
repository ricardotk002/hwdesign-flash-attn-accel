...
proc run_exec {fileExe} {
	...
	set ret [catch {eval exec "./$fileExe rtl | tee tmp.log" >&@ stdout} err]
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "flash_attention_hls.autotvin.dat"
	set constFileTvOut       "flash_attention_hls.autotvout.dat"
	set constFileHdlTvIn     "flash_attention_hls.autohdltvin.dat"
	set constFileHdlTvOut    "flash_attention_hls.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
