...
$(ObjDir)/tb_flash_attention.cpp_pre.cpp.tb.o : tb_flash_attention.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling tb_flash_attention.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/flash_attention.cpp_pre.cpp.tb.o : flash_attention.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling flash_attention.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
