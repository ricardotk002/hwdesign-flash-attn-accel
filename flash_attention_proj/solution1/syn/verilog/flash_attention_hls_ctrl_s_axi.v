...
// ==============================================================
`timescale 1ns/1ps
module flash_attention_hls_ctrl_s_axi
#(parameter
...
localparam
    ...
    ADDR_D_DATA_0      = 7'h48,
    ADDR_D_CTRL        = 7'h4c,
    ADDR_CAUSAL_DATA_0 = 7'h50,
    ADDR_CAUSAL_CTRL   = 7'h54,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_CAUSAL_DATA_0)
            int_causal[31:0] <= (WDATA[31:0] & wmask) | (int_causal[31:0] & ~wmask);
    end
end
